...
$query_pessoa = "SELECT * FROM evento WHERE ativo=1;";
...
$pdf->Cell(90, 10, 'Título', 1, 0, "C");
$pdf->Cell(40, 10, 'Início', 1, 0, "C");
$pdf->Cell(40, 10, 'Fim', 1, 0, "C");
//$pdf->Cell(60, 10, 'Data de Nascimento', 1, 0, "C");
$pdf->Ln();
//linhas da tabela
$pdf->SetFont('arial', '', 12);
while ($resultado2 = mysql_fetch_array($exe_query)) {
    $pdf->Cell(90, 10, utf8_encode($resultado2['titulo']), 1, 0, "L",0,0);
    $pdf->Cell(40, 10, $resultado2['periodoon'], 1, 0, "C",0,0);
    $pdf->Cell(40, 10, $resultado2['periodooff'], 1, 0, "C",0,0);
    //$pdf->Cell(60, 10, $resultado2['datanasc_formatada'], 1, 0, "C");
    $pdf->Ln();
}
$pdf->Cell(90, 10, '', 0, 0, "C");
$pdf->Cell(40, 10, '', 0, 0, "C");
$pdf->Cell(40, 10,'número de eventos ativos: ' . $num_rows, 0, 0, "C");
ob_end_clean(); #al�m de limpar tamb�m mostra aquilo que foi armazenado no buffer                
$pdf->Output("eventos.pdf","I"); #necess�rio para gerar o PDF. Dentro dos parentes voc� consegue definir se o PDF ser� salvo e o nome com caminho de onde ser� salvo
