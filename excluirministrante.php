                            ...
                            <div class="container-fluid">
                                <div class="row-fluid">
                                    ...
                                    <div class="span9">
                                        <br>
                                        <?php
                                        $sql = "SELECT atividades.titulo, pessoa.nome FROM ministrantes "
                                        ...
                                        if (mysql_num_rows($resultado) > 0) {
                                            ...
                                            echo "<script>alert('Existe um vínculo com atividade cadastrada. Não é possível excluir o ministrante.')</script>";
                                            echo "<script>alert('Contate o Administrador do Sistema.')</script>";
                                            echo "<script>history.back();</script>";
                                        } else {
                                            $registro = mysql_fetch_array($resultado);
                                            $query = "DELETE FROM ministrantes WHERE idministrantes = '$id'";
