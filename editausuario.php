                    ...
                    <div class="container-fluid">
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                                                        ...
                                                        <table class="tabela_02">
                                                            ...
                                                            <tbody><tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="fundotd"><input name="datanascimento" id="12" value="<?php echo $row['data_nasc']; ?>" class="formulario" maxlength="10" type="text"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fundotd" align="right">Cidade:</td>
                                                                    <td class="fundotd">
                                                                        <input class="formulario form-control" name="cidade" id="13" value="<?php echo utf8_encode($row['cidade']); ?>" size="100" maxlength="100" type="text">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fundotd" align="right">Estado:</td>
                                                                    <td class="fundotd">
                                                                        <input name="estado" id="14" value="<?php echo $row['estado']; ?>" size="2" maxlength="2" class="formulario" type="text" onkeyup="toUpper(this);">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fundotd" align="right">Tel. celular:</td>
                                                                    <td class="fundotd">
                                                                        <input name="telCel" id="15" value="<?php echo $row['telefone']; ?>" size="11" maxlength="11" class="formulario" type="text">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="fundotd" align="right">CAMPUS ao qual pertence?</td>
                                                                    <td class="fundotd td_com_input">
                                                                        <input class="formulario formulario_input form-control" name="instituicao" id="17" value="<?php echo utf8_encode($row['Nome_Instituicao']); ?>" maxlength="23" type="text" onkeyup="toUpper(this);"></td>
                                                                </tr>
                                ...
                                <div align="left">
                                    <a href="javascript:fun()" class="btn btn-success" onclick="window.history.back()"><span title="Voltar página"><i class="icon-backward"></i> VOLTAR</span></a>
                                </div>
                                <br/>
                            </div>    
                        </div>
